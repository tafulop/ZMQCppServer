...
${TESTDIR}/tests/SocketTest.o: tests/SocketTest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/SocketTest.o tests/SocketTest.cpp


${TESTDIR}/tests/SocketTestRunner.o: tests/SocketTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/SocketTestRunner.o tests/SocketTestRunner.cpp
